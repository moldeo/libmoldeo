...
namespace OGLFT {
  ...
  void Filled::init ( void )
  {
    ...
    gluTessCallback( (GLUtriangulatorObj *)tess_obj_, GLU_TESS_VERTEX, (GLUTessCallback)vertexCallback );
    gluTessCallback( (GLUtriangulatorObj *)tess_obj_, GLU_TESS_BEGIN, (GLUTessCallback)beginCallback );
    gluTessCallback( (GLUtriangulatorObj *)tess_obj_, GLU_TESS_END, (GLUTessCallback)endCallback );
    gluTessCallback( (GLUtriangulatorObj *)tess_obj_, GLU_TESS_COMBINE_DATA, (GLUTessCallback)combineCallback );
    gluTessCallback( (GLUtriangulatorObj *)tess_obj_, GLU_TESS_ERROR, (GLUTessCallback)errorCallback );
  }
