...
/**
 * Esta clase define un filtro 2D para aplicar en texturas. Un filtro es b�sicamente
 * un programa de shader (escrito en CG o GLSL) con un conjunto de predefinido de par�metros
 * uniformes y una grilla 2D donde las texturas fuente son mapeadas. Los puntos de la grilla 2D
 * pueden ser modificados en el estadio de v�rtices del filtro, permitiendo distorsiones arbitrarias
...
public:
     ...
     * @param p_src_tex referencia a la lista de texturas de or�gen.
     ...
     * @param p_params puntero al objeto de par�metros a utilizar en este filtro.
     ...
     * @return puntero a la lista de texturas de or�gen.
     */
    ...
    /**
     * Verifica que todas las texturas de destino est�n asociadas a lo b�fers de color del mismo FBO. En caso
     * contrario, las mismas ser�n re-asociadas (utilizando el FBO de la primera textura de destino) en el
