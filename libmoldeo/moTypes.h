...
/*STANDARD LIBRARIES: define here or die*/
    ...
    #define NOGDI //comentar esta l�nea con MinGW64??
    //#undef _WINDOWS_
    #define MO_GSTREAMER
...
const moTexParam MODefTex2DParams =
{
    ...
    GL_LINEAR, /// (GL_NEAREST_MIPMAP_LINEAR) interpolaci�n de filtro lineal para el achicamiento
    GL_LINEAR, /// (GL_NEAREST_MIPMAP_LINEAR) interpolaci�n de filtro lineal para el agrandamiento
