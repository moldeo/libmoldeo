...
/// Base abstracta de base para las geometr�as.
/**
*	Todas las geometr�as como Cubo, Esfera, Triangulo, .. derivan de esta clase
* que contiene un vector de vertices y otro de indices que referencian a esos vertices.
* El modo directo que consiste en simplemente usar el vector de vertices para dibujar la geometr�a, puede
...
/**
*	Los moWidget 's  son los elementos b�sicos del GUI ( Graphical User Interface ) de Moldeo.
*/
...
/// Ventana simple
/**
*	Dibuja una ventana especificando posici�n y tama�o
*
*	@see moWidget
*	@see moGUIObject
*	@see moGUIManager
