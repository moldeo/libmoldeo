...
class LIBMOLDEO_API moEffectState:public moAbstract
{
	...
	public:
		 ...
		 * 100%: 1
		 */
		MOfloat tints;			 ///saturacin

		/**
		 * fulldebug: informacin adicional para correccin de errores
		 * descativado: -1
		 * activado: 1
		 */
		MOswitch fulldebug;
		...
		/**
		 * 3d stereo capable: capacitado para diferenciar visin entre ojo izquierdo y derecho, profundidad
		 * descativado: -1
		 * activado: 1
		 */
		MOswitch stereo;
