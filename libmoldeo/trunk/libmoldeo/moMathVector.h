...
// moVector2 class ------------------------------------------------------------
template < class Real > class LIBMOLDEO_API moVector2:public moAbstract
{
	public:
		// construction
		moVector2 ()
		...
		{
			return moVector2 (m_afTuple[0] + rkV.m_afTuple[0],
				m_afTuple[1] + rkV.m_afTuple[1]);
		}
		...
		{
			return moMath <
				Real >::Sqrt (m_afTuple[0] * m_afTuple[0] + m_afTuple[1] * m_afTuple[1]);
		}
...
// arithmetic operations
template < class Real > inline moVector2 < Real > operator* (Real fScalar,
const
moVector2 <
Real > &rkV)
{
