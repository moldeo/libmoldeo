 ...
 * pero podra ser modificada en el futuro
 * cada tipo aqu especificado puede estar implementado por un recurso interno del core o un plugin
 */
enum moResourceType
{  /*UNDEFINED*/ MO_RESOURCETYPE_UNDEFINED = 0,
/*INTERNAL CORE */
MO_RESOURCETYPE_FILE, MO_RESOURCETYPE_VIDEO, MO_RESOURCETYPE_NET,
MO_RESOURCETYPE_FILTER, MO_RESOURCETYPE_TIME, MO_RESOURCETYPE_DATA,
MO_RESOURCETYPE_TEXTURE, MO_RESOURCETYPE_SOUND, MO_RESOURCETYPE_MODEL,
MO_RESOURCETYPE_FONT, MO_RESOURCETYPE_GUI, MO_RESOURCETYPE_RENDER,
MO_RESOURCETYPE_GL, MO_RESOURCETYPE_FB, MO_RESOURCETYPE_SHADER,
MO_RESOURCETYPE_SCRIPT, MO_RESOURCETYPE_MATH, MO_RESOURCETYPE_DEBUG,
/*EXTRAS*/ MO_RESOURCETYPE_TEXT, MO_RESOURCETYPE_MEMORY,
MO_RESOURCETYPE_XML, MO_RESOURCETYPE_DB, MO_RESOURCETYPE_DYNAMICENGINE,
MO_RESOURCETYPE_DECODER,  /*RESERVED*/ MO_RESOURCETYPE_RESERVED1,
MO_RESOURCETYPE_RESERVED2, MO_RESOURCETYPE_RESERVED3,
...
/// Recurso ( objeto para cargar y manipular objetos fsicos de datos de imgenes, audio, video, 3d, 2d, fuentes, shaders y de cualquier otro tipo extendible por un plugin )
/**
 *
 *  Los recursos son aquellos objetos que implementan funciones de tratamiento de datos, generalmente
 *  localizados en dispositivos fsicos, locales o remotos,o que tienen por destino algn tipo de representacin.
 *
 *  Aquellos recursos predeterminados dentro de la librera de Moldeo conforman la columna vertebral de las funcionalidades
 *  del Core de Moldeo.
 ...
 *
 *  Un plugin derivado de moResourcePlugin es usado tpicamente para acceder a archivos de distintos formatos para luego
 *  administrar estos contenidos en un arreglo interno dinmico evitando redundancias de datos.
 *
 *  Un ejemplo sera el moTextureManager, que administrar la carga de imgenes en texturas de opengl.
 *
 *  Otro ejemplo sera el mo3dModelManager, que administrar la carga de objeto 3d, en este caso del formato .3ds. El mo3dModelManager a su vez
 ...
 *  de los datos en Moldeo es una de las caractersticas importantes de su arquitectura.
 * @see moResourceType
 * @see moMoldeoObject
...
class LIBMOLDEO_API moResource:public moMoldeoObject
{
	...
	protected:void SetResourceType (moResourceType p_restype);
	private: moResourceType m_ResourceType;
...
/**
 * los recursos son aquellos objetos que implementan funciones de tratamiento de datos, generalmente de dispositivos fsicos,
 * como son imgenes, videos, bases de dato
 * @see moResource
 */
class LIBMOLDEO_API moResourceManager:public moAbstract
{
	public:
		...
		/**
		 * inicializacin
		 * se especifican los parmetros generales para el acceso a los datos
		 *
		 */
		 ...
		 *
		 */
		MOboolean NewResource (moText p_resname, int paramindex =
			-1, int valueindex = -1);
