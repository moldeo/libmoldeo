...
/// Modos de combinacin
/**
 *   Modos de combinacin predeterminados
 *   Estos valores son referencias para los modos de combinacin de colores que suelen usarse y estn ya implementados
 *   bajo OpenGL a travs de la funcin glBlend()
 */
enum moBlendingModes
{								 /// transparencia
	MO_BLENDING_TRANSPARENCY = 0,
								 /// aditivo segn transparencia
	MO_BLENDING_ADDITIVEALPHA = 1,
	MO_BLENDING_MIXING = 2,		 /// mezcla
	MO_BLENDING_MULTIPLY = 3,	 /// multipliacin
	MO_BLENDING_EXCLUSION = 4,	 /// exclusin
	MO_BLENDING_ADDITIVE = 5,	 /// aditivo por color
	MO_BLENDING_OVERLAY = 6,	 /// sobrecarga
	MO_BLENDING_SUBSTRACTIVE = 7,/// sustraccin
	MO_BLENDING_SATURATE = 8,	 /// saturacin
	MO_BLENDINGS = 9			 /// cantidad de modos
};

/// Modos de dibujado de polgonos
/**
 *   Modos de dibujado de polgonos
...
{								 /// relleno
	...
	MO_POLYGONMODE_LINE = 1,	 /// slo lneas
	MO_POLYGONMODE_POINT = 2,	 /// slo puntos
...
/**
 *   Modo estereoscpico
 *   Para la estereoscopa se fijan estos modos
 */
enum moStereoSides
{
	MO_STEREO_NONE = 0, MO_STEREO_LEFT = 1, MO_STEREO_RIGHT = 2
};
...
/**
 * Definicin y enumeracin de tipos de objetos en Moldeo
 *
 */
...
{								 /// Objeto indefinido
	...
	MO_OBJECT_POSTEFFECT = 2,	 /// Objeto dibujable, post-efecto ( ltmos efectos en el orden de dibujado )
	MO_OBJECT_MASTEREFFECT = 3,	 /// Objeto dibujable, efecto-maestro ( puede controlar otros efectos )
	MO_OBJECT_IODEVICE = 4,		 /// Dispositivo de entrada/salida, tpicamente, interfaces humanas de IO y datos ( teclado, mouse, tableta, tcp, udp, serial )
	MO_OBJECT_RESOURCE = 5,		 /// Recursos de datos, objetos, imgenes, videos y funcionalidades mltiples
	MO_OBJECT_CONSOLE = 6,		 /// Objeto principal de administracin y dibujado de objetos de Moldeo
	MO_OBJECT_TYPES = 7			 /// referencia para la cantidad de tipos de objetos
};

/// Parmetros internos de una textura
/**
 * moTexParam
 *  estructura que representa la parametrizacin de una textura en OPENGL
 */
...
/// Parmetros internos predeterminados de una textura
/**
 * MODefTex2DParams
 *  Parmetros internos predeterminados de una textura
 *
...
const moTexParam MODefTex2DParams =
{
	...
	GL_LINEAR,					 /// interpolacin de filtro lineal para el achicamiento
	GL_LINEAR,					 /// interpolacin de filtro lineal para el agrandamiento
	GL_REPEAT,					 /// modo de repeticin en el orden horizontal
	GL_REPEAT					 /// modo de repeticin en el orden vertical
};

/// Parmetros internos predeterminados de una textura no identificados
/**
 * MOUndefinedTex
 *  Parmetros internos predeterminados de una textura no identificados
 *
...
{
	MO_UNDEFINED, MO_UNDEFINED, MO_UNDEFINED, MO_UNDEFINED, MO_UNDEFINED,
	MO_UNDEFINED
};

///Devuelve en milisegundos el valor del reloj de Moldeo
/**
 *   Funcin global que devuelve en milisegundos el valor del reloj de Moldeo
 *   Esta funcin devuelve un valor relativo al inicio de la lnea de tiempo de Moldeo
...
///Devuelve en milisegundos el valor del reloj de Moldeo
/**
 *   Funcin global que devuelve en milisegundos el valor del reloj absoluto
 *   Esta funcin devuelve un valor absoluto del reloj de la mquina
 *   Este valor depender de la implementacin segn el sistema operativo y la librera utilizada,
 *   y afectar el comportamiento de los otros temporizadores
 */
LIBMOLDEO_API MOulong moGetTicksAbsolute ();

///macros para mximos y mnimos
/**
 *   macros para mximos y mnimos
 */
#ifndef momax
