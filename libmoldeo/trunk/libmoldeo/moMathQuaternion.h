...
template < class Real > class LIBMOLDEO_API moQuaternion:public moAbstract
{
	public:
		...
		inline moQuaternion operator* (const moQuaternion & rkQ) const
		{
			...
			moQuaternion kProd;
			kProd.m_afTuple[0] =
				m_afTuple[0] * rkQ.m_afTuple[0] - m_afTuple[1] * rkQ.m_afTuple[1] -
				m_afTuple[2] * rkQ.m_afTuple[2] - m_afTuple[3] * rkQ.m_afTuple[3];
			kProd.m_afTuple[1] =
				m_afTuple[0] * rkQ.m_afTuple[1] + m_afTuple[1] * rkQ.m_afTuple[0] +
				m_afTuple[2] * rkQ.m_afTuple[3] - m_afTuple[3] * rkQ.m_afTuple[2];
			kProd.m_afTuple[2] =
				m_afTuple[0] * rkQ.m_afTuple[2] + m_afTuple[2] * rkQ.m_afTuple[0] +
				m_afTuple[3] * rkQ.m_afTuple[1] - m_afTuple[1] * rkQ.m_afTuple[3];
			kProd.m_afTuple[3] =
				m_afTuple[0] * rkQ.m_afTuple[3] + m_afTuple[3] * rkQ.m_afTuple[0] +
				m_afTuple[1] * rkQ.m_afTuple[2] - m_afTuple[2] * rkQ.m_afTuple[1];
			return kProd;
		}
		...
		{
			return moMath <
				Real >::Sqrt (m_afTuple[0] * m_afTuple[0] +
		...
		inline Real Dot (const moQuaternion & rkQ) const
		{
			Real fDot = (Real) 0.0;
			for (int i = 0; i < 4; i++)
		...
		moQuaternion & Slerp (Real fT, const moQuaternion & rkP,
		...
		moQuaternion & Intermediate (const moQuaternion & rkQ0,
			...
			const moQuaternion & rkQ2);

		// spherical quadratic interpolation
		moQuaternion & Squad (Real fT, const moQuaternion & rkQ0,
			const moQuaternion & rkA0,
			const moQuaternion & rkA1,
			const moQuaternion & rkQ1);
		...
		// V2 = (x2,y2,z2).
		moQuaternion & Align (const moVector3 < Real > &rkV1,
		...
		void DecomposeTwistTimesSwing (const moVector3 < Real > &rkV1,
			moQuaternion & rkTwist,
			moQuaternion & rkSwing);
...
template < class Real > inline moQuaternion < Real >
operator* (Real fScalar, const moQuaternion < Real > &rkQ)
{
