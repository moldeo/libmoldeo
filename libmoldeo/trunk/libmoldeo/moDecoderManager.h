...
/**
 * Esta clase implementa un administrador para la API de VDPAU de reproduccin de videos
 * que hace uso en LINUX del hardware especfico de NVidia con la arquitectura de chips VP1/VP2
 * Esta librera permite reproducir archivos de tipo MPEG2, H264, WMV, VC1, total o parcialmente
 * acelerados por esta librera.
