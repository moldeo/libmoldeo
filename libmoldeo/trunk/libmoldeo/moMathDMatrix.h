...
// moDMatrix class ------------------------------------------------
template < class Real > class LIBMOLDEO_API moDMatrix:public moAbstract
{
	public:
...
// c * M
template < class Real > moDMatrix < Real > operator* (Real fScalar,
const moDMatrix <
Real > &rkM);

// v^T * M
template < class Real > moDVector < Real > operator* (const moDVector <
Real > &rkV,
const moDMatrix <
Real > &rkM);
...
template < class Real > class moDBandedMatrix:public moAbstract
{
	public:moDBandedMatrix (int iSize, int iLBands, int iUBands);
