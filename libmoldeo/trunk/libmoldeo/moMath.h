...
/**
 * Clase template que implementa funciones matemticas bsicas. Si bien muchas de ellas
 * ya estn disponibles en las libreras estndard de C, las provistas aqu ofrecen
 * algoritmos aproximados ms rpidos, control de bordes, etc.
 * Las funciones aceleradas (Fast*) implementan evaluaciones rpidas de funciones
 * trigonomtricas y sus inversas, utilizando aproximaciones polinomiales.
 ...
 */
template < class Real > class LIBMOLDEO_API moMath
{
	public:
		/**
		...
		/**
		 * Funcin arco coseno, el argumento es restringido al intervalo [-1,1].
		...
		/**
		 * Funcin arco seno, el argumento es restringido al intervalo [-1,1].
		 * @param fValue argumento.
		 * @return resultado.
		 */
		...
		/**
		 * Funcin arco tangente 2. Calcula el arco tangente de fY/fY, pero devolviendo un resultado
		 * en el rango (-PI, PI].
		 * @param fValue argumento.
		 * @return resultado.
		 */
		...
		/**
		 * Calcula el logaritmo en base 2 de un nmero que es una potencia de 2.
		...
		/**
		 * Conversin rpida de un nmero fFloat de punto flotante de 32 bits en el intervalo [0,1]
		 *a un entero de 32 bits en [0,2^iLog-1].
		 * @param fFloat nmero a convertir.
		 * @param iLog exponende del lmite derecho del intervalo.
		 * @return resultado de la conversin.
		 */
		...
		/**
		 * Funcin signo (devuelve -1 si el argumento es negtivo, 0 si es cero, y +1 si es positivo).
		 * @param iValue argumento.
		 * @return resultado.
		 */
		inline static char Sign (int iValue)
		{
			if (iValue > 0)
		...
		/**
		 * Genera un nmero aleatorio en [0,1). El generador puede ser inicializado con una primera llamada
		 * pasando como parmetro una semilla positiva.
		 * @param uiSeed semilla para el generador aleatorio.
		 * @return nmero aleatorio en en [0,1).
		 */
		...
		/**
		 * Genera un nmero aleatorio en [-1,1). El generador puede ser inicializado con una primera llamada
		 * pasando como parmetro una semilla positiva.
		 * @param uiSeed semilla para el generador aleatorio.
		 * @return nmero aleatorio en [-1,1).
		 */
		...
		/**
		 * Genera un nmero aleatorio en [fMin,fMax). El generador puede ser inicializado con una primera llamada
		 * pasando como parmetro uiSeed una semilla positiva.
		...
		/**
		 * Genera un nmero aleatorio en [fMin,fMax). El generador puede ser inicializado con una primera llamada
		 * pasando como parmetro rSeed una semilla positiva.
		 * @param fMin extremo izquierdo del intervalo.
		 * @param fMax extremo derecho del intervalo.
		 * @param rSeed semilla para el generador aleatorio.
		 * @return resultado.
		...
		/**
		 * Funcin seno acelerada, version 0. Max error sin0 = 1.7e-04, aceleracin = 4.0
		...
		/**
		 * Funcin seno acelerada, version 1. Max error sin0 = 1.9e-08, aceleracin = 2.8
		 * @param fValue argumento en [0,pi/2].
		 * @return resultado.
		 */
		...
		/**
		 * Funcin coseno acelerada, version 0. Max error sin0 = 1.2e-03, aceleracin = 4.5
		 * @param fValue argumento en [0,pi/2].
		 * @return resultado.
		 */
		...
		/**
		 * Funcin coseno acelerada, version 1. Max error sin0 = 6.5e-09, aceleracin = 2.8
		 * @param fValue argumento en [0,pi/2].
		 * @return resultado.
		 */
		...
		/**
		 * Funcin tangente acelerada, version 0. Max error sin0 = 8.1e-04, aceleracin = 5.6
		...
		/**
		 * Funcin tangente acelerada, version 1. Max error sin0 = 1.9e-08, aceleracin = 3.4
		 * @param fValue argumento en [0,pi/4].
		 * @return resultado.
		 */
		...
		/**
		 * Funcin arco seno acelerada, version 0. Max error sin0 = 6.8e-05, aceleracin = 7.5
		...
		/**
		 * Funcin arco seno acelerada, version 1. Max error sin0 = 1.4e-07, aceleracin = 5.5
		 * @param fValue argumento en [0,1].
		 * @return resultado.
		 */
		...
		/**
		 * Funcin arco coseno acelerada, version 0. Max error sin0 = 6.8e-05, aceleracin = 7.5
		 * @param fValue argumento en [0,1].
		 * @return resultado.
		 */
		...
		/**
		 * Funcin arco coseno acelerada, version 1. Max error sin0 = 1.4e-07, aceleracin = 5.7
		 * @param fValue argumento en [0,1].
		 * @return resultado.
		 */
		...
		/**
		 * Funcin arco tangente acelerada, version 0. Max error sin0 = 1.2e-05, aceleracin = 2.8
		...
		/**
		 * Funcin arco tangente acelerada, version 1. Max error sin0 = 2.3e-08, aceleracin = 1.8
		 * @param fValue argumento en [-1,1].
		 * @return resultado.
		 */
		...
		/**
		 * Funcin exponencial negativa (exp(-x)) acelerada, version 0. Max error sin0 = 0.00024, aceleracin = 25.4
		...
		/**
		 * Funcin exponencial negativa (exp(-x)) acelerada, version 1. Max error sin0 = 0.000024, aceleracin = 25.4
		 * @param fValue argumento en [0,infinito).
		 * @return resultado.
		 */
		...
		/**
		 * Funcin exponencial negativa (exp(-x)) acelerada, version 2. Max error sin0 = 0.0000024, aceleracin = 20.5
		 * @param fValue argumento en [0,infinito).
		 * @return resultado.
		 */
		...
		/**
		 * Funcin exponencial negativa (exp(-x)) acelerada, version 2. Max error sin0 = 0.00000025, aceleracin = 17.3
		 * @param fValue argumento en [0,infinito).
		 * @return resultado.
		 */
...
template <> const MOlong moMath < MOlong >::TWO_PI =
2.0f * moMath < MOlong >::PI;
template <> const MOlong moMath < MOlong >::HALF_PI =
0.5f * moMath < MOlong >::PI;
template <> const MOlong moMath < MOlong >::INV_PI =
1.0f / moMath < MOlong >::PI;
template <> const MOlong moMath < MOlong >::INV_TWO_PI =
1.0f / moMath < MOlong >::TWO_PI;
template <> const MOlong moMath < MOlong >::DEG_TO_RAD =
moMath < MOlong >::PI / 180.0f;
template <> const MOlong moMath < MOlong >::RAD_TO_DEG =
180.0f / moMath < MOlong >::PI;
template <> const MOlong moMath < MOlong >::LN_2 =
moMath < MOlong >::Log (2.0f);
template <> const MOlong moMath < MOlong >::LN_10 =
moMath < MOlong >::Log (10.0f);
template <> const MOlong moMath < MOlong >::INV_LN_2 =
1.0f / moMath < MOlong >::LN_2;
template <> const MOlong moMath < MOlong >::INV_LN_10 =
1.0f / moMath < MOlong >::LN_10;
...
template <> const MOfloat moMath < MOfloat >::PI =
(MOfloat) (4.0 * atan (1.0));
template <> const MOfloat moMath < MOfloat >::TWO_PI =
2.0f * moMath < MOfloat >::PI;
template <> const MOfloat moMath < MOfloat >::HALF_PI =
0.5f * moMath < MOfloat >::PI;
template <> const MOfloat moMath < MOfloat >::INV_PI =
1.0f / moMath < MOfloat >::PI;
template <> const MOfloat moMath < MOfloat >::INV_TWO_PI =
1.0f / moMath < MOfloat >::TWO_PI;
template <> const MOfloat moMath < MOfloat >::DEG_TO_RAD =
moMath < MOfloat >::PI / 180.0f;
template <> const MOfloat moMath < MOfloat >::RAD_TO_DEG =
180.0f / moMath < MOfloat >::PI;
template <> const MOfloat moMath < MOfloat >::LN_2 =
moMath < MOfloat >::Log (2.0f);
template <> const MOfloat moMath < MOfloat >::LN_10 =
moMath < MOfloat >::Log (10.0f);
template <> const MOfloat moMath < MOfloat >::INV_LN_2 =
1.0f / moMath < MOfloat >::LN_2;
template <> const MOfloat moMath < MOfloat >::INV_LN_10 =
1.0f / moMath < MOfloat >::LN_10;
...
template <> const MOdouble moMath < MOdouble >::TWO_PI =
2.0 * moMath < MOdouble >::PI;
template <> const MOdouble moMath < MOdouble >::HALF_PI =
0.5 * moMath < MOdouble >::PI;
template <> const MOdouble moMath < MOdouble >::INV_PI =
1.0 / moMath < MOdouble >::PI;
template <> const MOdouble moMath < MOdouble >::INV_TWO_PI =
1.0 / moMath < MOdouble >::TWO_PI;
template <> const MOdouble moMath < MOdouble >::DEG_TO_RAD =
moMath < MOdouble >::PI / 180.0;
template <> const MOdouble moMath < MOdouble >::RAD_TO_DEG =
180.0 / moMath < MOdouble >::PI;
template <> const MOdouble moMath < MOdouble >::LN_2 =
moMath < MOdouble >::Log (2.0);
template <> const MOdouble moMath < MOdouble >::LN_10 =
moMath < MOdouble >::Log (10.0);
template <> const MOdouble moMath < MOdouble >::INV_LN_2 =
1.0 / moMath < MOdouble >::LN_2;
template <> const MOdouble moMath < MOdouble >::INV_LN_10 =
1.0 / moMath < MOdouble >::LN_10;
template <> long moMath < MOlong >::FastInvSqrt (MOlong fValue)
{
	return fValue;
}


template <> float moMath < MOfloat >::FastInvSqrt (MOfloat fValue)
{
...
template <> MOdouble moMath < MOdouble >::FastInvSqrt (MOdouble dValue)
{
