...
// moVector4 class ------------------------------------------------------------
template < class Real > class LIBMOLDEO_API moVector4:public moAbstract
{
	public:
		// construction
		moVector4 ()
		...
		{
			return moVector4 (m_afTuple[0] + rkV.m_afTuple[0],
				m_afTuple[1] + rkV.m_afTuple[1],
				m_afTuple[2] + rkV.m_afTuple[2],
				m_afTuple[3] + rkV.m_afTuple[3]);
		}
		...
		{
			return moVector4 (fScalar * m_afTuple[0], fScalar * m_afTuple[1],
				fScalar * m_afTuple[2], fScalar * m_afTuple[3]);
		}
		inline moVector4 operator/ (Real fScalar) const
		{
			moVector4 kQuot;
		...
		{
			return moVector4 (-m_afTuple[0], -m_afTuple[1], -m_afTuple[2],
				-m_afTuple[3]);
		}
...
// arithmetic operations
template < class Real > inline moVector4 < Real > operator* (Real fScalar,
const
moVector4 <
Real > &rkV)
{
	moVector4 < Real > v4 (fScalar * rkV[0], fScalar * rkV[1],
		fScalar * rkV[2], fScalar * rkV[3]);
	return v4;
}
