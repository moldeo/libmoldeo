/*******************************************************************************
  ...
  ****************************************************************************
  ...
  Description:
  Implementa un mtodo para agregar clases de moldeo a la mquina virtual de LUA,
  ...
  Cada link describe un mtodo diferente, el que se utiliza aqu es el segundo.
...
/**
 * Esta clase template esttica es utilizada para registrar clases de Moldeo dentro de la
...
template < typename T > class moLuna
{
	...
	public:typedef int (T::*mfp) (lua_State * L);
	typedef struct
	{
		const char *name;
		mfp mfunc;
	...
	/**
	 * Registra la clase T en la mquina virtual con estado L. El uso de esta funcin esttica es:
	 * moLuna<T>::Register(L);
	 * @param L puntero al estado de la mquina virtual.
	 */
	...
	private:moLuna ();			 // hide default constructor
	...
	static int thunk (lua_State * L)
	{
		...
		RegType *l =
			static_cast < RegType * >(lua_touserdata (L, lua_upvalueindex (1)));
