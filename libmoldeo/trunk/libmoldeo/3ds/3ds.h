...
#define MAT_AMBIENT_COLOR			0xA010				// This holds the ambient component color
#define MAT_DIFFUSE_COLOR			0xA020				// This holds the color of the object/material
#define MAT_SPECULAR_COLOR			0xA030				// This holds the specular component color
...
*/
#define MAT_TEXTURE_MAP1_CHUNK		0xA200                // This holds the file name of the texture
...
private:
    ...
    void ProcessNextObjectChunk(mo3dModel *pModel, mo3dObject *pObject, tChunk *);
    ...
    void ReadObjectMaterial(mo3dModel *pModel, mo3dObject *pObject, tChunk *pPreviousChunk);
